...
The complete OpenBSD 7.6 source tree is already available at `./src` in this workspace. Search and analyze that local tree; do not clone or download source code from elsewhere.
