/*	$OpenBSD: proc.c,v 1.43 2026/07/02 12:35:52 jsg Exp $	*/
	...
	for (proc = 0; proc < nproc; proc++) {
		...
		for (i = 0; i < ps->ps_instances[p->p_id]; i++) {
			...
			snprintf(num, sizeof(num), "%u", i);
				...
				/*
				 * Harness mode keeps the child endpoint open in this
				 * process.  main() writes generated snmpe messages to
				 * it instead of execing a separate snmpe process.
				 */
				(void)fd;
				continue;
#endif
